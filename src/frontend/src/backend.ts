...
import type { Entry as _Entry, EntryType as _EntryType, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
...
function from_candid_EntryType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EntryType): EntryType {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        entryType: from_candid_EntryType_n13(_uploadFile, _downloadFile, value.entryType),
        date: value.date,
        note: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.note)),
        category: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.category)),
        amount: value.amount
    };
}
