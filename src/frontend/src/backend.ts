...
import type { Entry as _Entry, EntryType as _EntryType, SavingsGoal as _SavingsGoal, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdateEntry(arg0: bigint | null, arg1: Time, arg2: EntryType, arg3: number, arg4: string | null, arg5: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateEntry(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, to_candid_EntryType_n2(this._uploadFile, this._downloadFile, arg2), arg3, to_candid_opt_n4(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n4(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addOrUpdateSavingsGoal(arg0: bigint | null, arg1: string, arg2: number, arg3: number, arg4: Time | null, arg5: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateSavingsGoal(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n4(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_EntryType_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EntryType): EntryType {
    return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function from_candid_Entry_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Entry): Entry {
    return from_candid_record_n13(_uploadFile, _downloadFile, value);
}
function from_candid_SavingsGoal_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SavingsGoal): SavingsGoal {
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        entryType: from_candid_EntryType_n14(_uploadFile, _downloadFile, value.entryType),
        date: value.date,
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        deadline: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.deadline)),
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "expense" in value ? EntryType.expense : "saving" in value ? EntryType.saving : value;
}
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Entry>): Array<Entry> {
    return value.map((x)=>from_candid_Entry_n12(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SavingsGoal>): Array<SavingsGoal> {
    return value.map((x)=>from_candid_SavingsGoal_n18(_uploadFile, _downloadFile, x));
}
function to_candid_EntryType_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EntryType): _EntryType {
...
function to_candid_variant_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: EntryType): {
    expense: null;
} | {
    saving: null;
} {
